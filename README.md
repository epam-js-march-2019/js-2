...
**Реализация**  
Выполнить задание необходимо с UI частью, использую DOM события. Выбор стилей, инструментов на личное усмотрение каждого, верстка оцениваться в рамках данной задачи не будет. 
